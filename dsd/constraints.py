...
class DomainPool(JSONSerializable):
    ...
    def _generate_sequences_satisfying_numpy_constraints(self, rng: np.random.Generator) -> List[str]:
        ...
        while seqs_satisfying_numpy_constraints.numseqs == 0 and updated_num_gen_sequences < 4 ** 15:
            # 4 ** 15 sequences or more takes over a minute to generate and an excessive amount of memory
            ...
            if updated_num_gen_sequences >= 4 ** 15:
                print("Unable to find satisfactory sequences for such constraints.")
