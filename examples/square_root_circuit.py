...
class SeesawCircuit:
    ...
    def _set_signal_strands(self) -> None:
        ...
        self.signal_strands = {(input_, gate): signal_strand(input_, gate) for input_, gate in input_gate_pairs}
    ...
    def _set_threshold_bottom_strands(self) -> None:
        ...
        self.threshold_bottom_strands = {
            (input_, gate): threshold_bottom_strand(input_, gate) for input_, gate in input_gate_pairs_with_threshold
        }
    ...
    def _set_threshold_top_strands(self) -> None:
        ...
        self.threshold_top_strands = {
            gate: threshold_top_strand(gate) for gate in gates_with_threshold_but_not_reporter
        }
    ...
    def _set_reporter_bottom_strands(self) -> None:
        ...
        self.reporter_bottom_strands = {(input_, gate): reporter_bottom_strand(gate) for input_, gate in reporter_gates}
...
def input_gate(gate_name: int, input_: int) -> SeesawGate:
    ...
    :rtype: SeesawGate
    """
    return SeesawGate(gate_name=gate_name, inputs=[input_], has_threshold=True, has_fuel=True)
